...
\input{Qcircuit}
\input{phd-macros}
\title{An investigation of quantum and reversible computing \\
\bigskip  }
%
...
\input{chapters/abstract-computability}
\input{chapters/quantum-computation}
\input{chapters/inversecategories}
\input{chapters/frobenius-algebras}
\input{chapters/inverse-sum-cats}
\input{chapters/sums-in-frobenius}
%\input{chapters/chapter-iterate-and-fold}
