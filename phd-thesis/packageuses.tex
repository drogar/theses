...
\tikzstyle{delta}=[isosceles triangle, isosceles triangle apex angle=70, draw, shape border rotate=90, minimum size=4mm]
\tikzstyle{eta}=[circle, draw, minimum size=2mm]
\tikzstyle{epsilon}=[circle, draw, fill=black!75, minimum size=2mm]
\tikzstyle{nabla}=[isosceles triangle, isosceles triangle apex angle=70, draw, shape border rotate=270, minimum size=4mm]
