...
\section{Equivalence classes of maps in \hypX} % (fold)
...
\section{The category \hypXt is a discrete restriction category} % (fold)
...
\begin{proof}
  ...
  \]
\end{proof}
\section{Equivalence of categories} % (fold)
