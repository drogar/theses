...
make it reversible: Here we know how to remove the history to make it invertible!
...
The functor $\Invf$ maps a discrete Cartesian restriction category to its inverse subcategory and
maps functors between discrete Cartesian restriction categories to a functor having the same action
