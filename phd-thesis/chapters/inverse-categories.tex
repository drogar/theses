...
This chapter will focus on adding ``products'' to an inverse category, from Definition~\ref{def:inverse_category}.
...
an inverse category which we call \emph{inverse products}. These will be defined below in
...
\begin{definition}\label{def:inverse_product}
  ...
  monoidal category and there is a natural  ``semi-Frobenius'' diagonal map, $\Delta$.   If an
...
\begin{proof}
  ...
  \end{align}
  We will give the details of the proof for Equation~\ref{eq:frobenius_riinghths_expressed_in_x}.
