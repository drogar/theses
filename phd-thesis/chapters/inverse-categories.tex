...
\begin{lemma}\label{lem:delta_nabla_maps_are_closed}
  ...
  \item it is closed under pre-composition or post-composition with restriction idempotents, i.e., with
    $e=\rst{e}:A\*Y\to A\*Y$  or $d=\rst{d}:A\*Z\to Z\*Z$.\label{lemitem:delta_nabla_5}
  \end{enumerate}
\end{lemma}
\begin{proof}
...
For~\ref{lemitem:delta_nabla_5}, using
...
\[
  ...
  \begin{matrix}
    \begin{tikzpicture}
      ...
      \node at (.5,4) (s2) {};
      \node at (0.25,3.5) [delta] (d1) {};
      \node at (.65,3) [map] (h) {$\scriptstyle \ e\ $};
      \node at (.65,2.5) [map] (g) {$\scriptstyle \ h\ $};
      \node at (0.25, 2) [nabla] (n1) {};
      \node at (0.25,1.5) (end1) {};
      \node at (.5,1.5) (end2) {};
      \draw [] (s1) to (d1);
  ...
  \end{matrix}
\]
and therefore we need to show $(\Delta\*1) e = e (\Delta\*1)$.
Calculating,
\[
  (\Delta\*1) e =
  \begin{matrix}
    \begin{tikzpicture}
      ...
      \node at (.5,4) (s2) {};
      \node at (0.25,3.5) [delta] (d1) {};
      \node at (.65,3) [map] (e) {$\scriptstyle \ e\ $};
      \node at (0.25,2.5) (end1) {};
      \node at (.5,2.5) (end2) {};
      \node at (.75,2.5) (end3) {};
      \draw [] (s1) to (d1);
      \draw (d1) to[out=235,in=90] (end1);
      \draw (d1) to[out=305,in=125] (e);
      \draw [] (s2) to[out=270,in=55] (e);
      \draw (e) to[out=235,in=90] (end2);
      \draw (e) to[out=305,in=90] (end3);
    \end{tikzpicture}
  \end{matrix}
  =
  \begin{matrix}
    \begin{tikzpicture}
      \node at (0,4) (s1) {};
      \node at (.75,4) (s2) {};
      \node at (0,3.5) [delta] (d0) {};
        \node at (0.25,3) [delta] (d1) {};
        \node at (0.75,3) [delta] (d2) {};
        \node at (.5,2.5) [map] (e) {$\scriptstyle e$};
        \node at (0.25,2) [nabla] (n1) {};
        \node at (0.75,2) [nabla] (n2) {};
      \node at (0,1.5) (end1) {};
      \node at (.25,1.5) (end2) {};
      \node at (.75,1.5) (end3) {};
      \draw [] (s1) to (d0);
      \draw [] (s2) to (d2);
      \draw (d0) to[out=235,in=90] (end1);
      \draw (d0) to[out=305,in=90] (d1);
      \draw (d1) to[out=235,in=125] (n1);
      \draw (d1) to[out=305,in=110] (e);
      \draw (d2) to[out=235,in=70] (e);
      \draw (d2) to[out=305,in=55] (n2);
      \draw (e) to[out=250,in=55] (n1);
      \draw (e) to[out=290,in=125] (n2);
      \draw (n1) to (end2);
      \draw (n2) to (end3);
    \end{tikzpicture}
  \end{matrix}
  ...
  \begin{matrix}
    \begin{tikzpicture}
      ...
      \draw (e) to[out=250,in=55] (n1);
      \draw (e) to[out=290,in=125] (n2);
      \draw (n1) to[out=270,in=90] (d0);
      \draw (n2) to (end3);
    \end{tikzpicture}
  \end{matrix}
  =e (\Delta \*1).
\]
The proof for post-composing with an idempotent follows a similar pattern.
\end{proof}
