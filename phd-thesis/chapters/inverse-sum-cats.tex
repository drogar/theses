...
\end{equation}
is also a commuting diagram in an inverse category.
...
\begin{proof}
  ...
  commute as per Definition~\ref{def:distributive_inverse_category}.
  distributivity of $\*$ over $\+$. But this then says that
