...
\end{proof}
\subsubsection{Disjointness via a monoidal tensor} % (fold)
...
% sub-subsection disjointness_via_a_monoidal_tensor (end)
...
% sub-subsection inverse_sum_tensor_definitions (end)
...
\end{proof}
% sub-subsection disjointness_and_the_inverse_sum_tensor (end)
...
% sub-subsection inverse_sums_and_the_inverse_sum_tensor (end)
