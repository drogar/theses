...
powerful in \Xt. Assuming the retractions are $(m_n,r_n): A^n \retract A$, we have $m_j r_j =
...
\begin{lemma}\label{lem:powerful_inverse_partial_combinatory_algebra}
  ...
  is  a powerful object in \X, with $(m_n,r_n)\*^n A \retract A$. Then \axiom{iCPA}{1},
