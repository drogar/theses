...
\begin{proof}
  ...
  Next, note that for any monic $m$, we have $f$ is in the equivalence class of $f m$. This is
  because $\rst{f} = \rst{fm}$ by Lemma~\ref{lem:restrictionvarious}, .... NEED WORK HERE.

  We have both $T\*C \retract T$
  and $D \retract T$, and as equivalence is a transitive relation, we may express
