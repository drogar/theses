...
\begin{definition}\label{def:equivalence_of_categories}
  ...
  functors, $F:\A \to \B$ and $G:\B \to \A$ and natural isomorphisms such that $FG \cong I:\A \to
  \A$ and $GF \cong I:\B \to \B$.
\end{definition}
...
\begin{example}[Skeleton]\label{ex:skeleton}
   ...
   have immediately that $FG = I$ and as $\phi_S:|S|\to S$ in \finsets is an isomorphism, we have
   $\phi:GF \to I$.
...
Revisiting Example~\ref{ex:skeleton} above, we see that $(1,\phi):F\leftadjoint G: \ord \to \finsets$.
%%% Local Variables:
%%% mode: latex
