...
Sub-Section~\ref{sub:inverse_product_tensor}: Inverse products are given by a natural structure on a
...
\begin{definition}\label{def:inverse_product}
  ...
  The diagonal map $\Delta_A:A \to A\*A$ must be total and satisfy the diagrams in
  Figures~\ref{fig:inverse_product_cocommutativity}, \ref{fig:inverse_product_coassociativity},
  \ref{fig:inverse_product_exchange}, and \ref{fig:inverse_product_frobenius}.
\begin{figure}[!htbp]
  \[
