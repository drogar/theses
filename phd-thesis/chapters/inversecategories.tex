...
equivalent to the the category of discrete Cartesian restriction categories. In order to prove this,
we show how to construct a discrete Cartesian restriction category, \Xt, from a discrete inverse
category, \X.
