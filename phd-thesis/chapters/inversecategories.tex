...
v        \draw (g) to (finv);
    ...
    \item[\ref{le:dfgisfg}] Our assumption is that:
      ...
      \ \raisebox{45pt}{$= g.$}\
      \]
    \item[\ref{le:fgisfg}] Use the same diagram argument as in item \ref{le:dfgisfg}.
  \end{enumerate}
\end{proof}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    & = \restr{f(g\*1) ((h\*1)\*1) }
      & a_{\*}   \text{ isomorphism, Lemma \ref{lem:restrictionvarious}}\\
    & = \restr{f(g\*1) ((h\*1)\*1) (a_{\*}\*1)}
      & a_{\*}\*1 \text{ isomorphism, Lemma \ref{lem:restrictionvarious}}\\
    & = \restr{f((g (h\*1)a )\*1)} & \text{ see above}\\
    & = \restr{f((g (h\*1)a )\*1)a_{\*}} & a_{\*}   \text{ isomorphism}
  \end{align*}
...
\begin{proof}
  ...
  \rone ($\restr{f} f = f$). Calculating the restriction of the left hand side in
      ...
      \begin{align*}
        ...
        & = \restr{f } & \inv{\usr}   \text{ isomorphism, Lemma \ref{lem:restrictionvarious}}.
      \end{align*}
    ...
    \rthree ($\restr{\restr{f} g} = \restr{f} \restr{g}$ ). We must show
      ...
      \begin{align*}
        ...
        & = \rst{\restr{(\restr{f} \inv{\usr}) (g\* 1) a_{\*}}} & \inv{\usr}
          \text{ isomorphism, Lemma \ref{lem:restrictionvarious}}\\
      ...
      \begin{align*}
        ...
        & = \rst{f} \inv{\usr} \rst{g\* 1} & \text{\rthree, \rfour, }a_{\*} \text{ isomorphism} \\
        & = \rst{f} \rst{g} \inv{\usr} & \*
...
\begin{proof}
  ...
  \begin{align*}
    ...
    &=\rst{\Delta(f\*g)}\inv{\usr} &c_{\*}\text{ is isomorphism}\\
