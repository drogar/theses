...
\begin{example}\label{ex:algebras-not-preserving-unit-as-restriction-cat}
  Given $S$ is a symmetric monoidal category, let \D be the category whose objects are the objects
  of $S$ which are commutative monoids and maps the homomorphisms of monoids that do not
  necessarily preserve the unit.
  ...
  operator on $f:A\to B$ with $\rst{f}:B\to B$ fulfilling the restriction axioms.
\end{example}
