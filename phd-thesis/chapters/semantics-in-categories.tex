...
\begin{notation}\label{notn:hom-set}
  If $\X$ is a category, then the maps from $A$ to $B$ in $\X$ are written $\X(A,B)$.
...
\begin{definition}\label{def:categorical_biproduct}
  ...
  referred to as the \emph{biproduct} and designated as $A\biproduct B$. Note this is often written
  as $\+$. As we will be using $\+$ frequently in this thesis where it is not a biproduct, this
  alternate notation of $\biproduct$ will be used instead.
\end{definition}
