...
relation and a disjoint join in an inverse category  --- at which point we shall see that $A\+B$ is
a disjoint sum.
...
Our first step will be to  show how a disjointness tensor, defined below, may be used to create a
