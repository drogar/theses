...
the pairing map $f\tjdown g$ allows us to ensure the restrictions of $f$ and $g$ are disjoint, while
...
Finally, we show that the disjoint sum tensor is universal with respect to the disjoint join.
