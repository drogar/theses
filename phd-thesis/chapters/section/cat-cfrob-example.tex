...
consequences resulting when the base bicategory is locally posetal.

Coecke, Paquette and Pavlovi\'c in  \cite{coecke08classical}, model quantum and
...
choice made in the section to examine \CFrob.
\end{remark}
