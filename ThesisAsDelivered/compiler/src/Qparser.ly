...
>    : CID '(' typevar_list ')' {Constructor $1  $3}
>    | CID {Constructor $1 []}
>
> typevar_list :: {[Qtype]}
>    : typevar moretypevar_list {$1:$2}
>
> moretypevar_list ::  {[Qtype]}
>    : ',' typevar moretypevar_list {$2:$3}
>    | {- empty -} {[]}
>
>
> typevar ::{Qtype}
...
>    : ID ':' CID '(' typevar_list ')' {ParameterDefinition $1 (DECLTYPE $3  $5)}
>    | ID ':' CID {ParameterDefinition $1 (DECLTYPE $3 [])}
...
>      | IF guards   {Guard $2 }
>      | stmt cby identifier_list {ControlledBy $1 $3}
>      | SKIP                            {Skip}
>      | ZERO                       {ZeroStack}
>
>
